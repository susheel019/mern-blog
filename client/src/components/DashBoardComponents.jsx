...
function DashBoardComponents() {
  ...
  const [lastMonthUsers, setLastMonthUser] = useState(0);
  ...
  console.log("last month user", lastMonthUsers);

  console.log("comment", comments);
  console.log("total comment", totalComments);
  console.log("last month comment", lastMonthComment);
  ...
  useEffect(() => {
    ...
    const fetchComments = async () => {
      ...
      if (res.ok) {
        ...
        setTotalComments(data.totalNumberOfComment);
